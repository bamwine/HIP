				...
				<div class="slider">
					<div class="callbacks_container">
						    <ul class="rslides" id="slider">
								<li><h3>HIPHOP MUSIC WORLD</h3></li>	
								<li><h3>WORLDS BEST MUSIC</h3></li>	
						    </ul>
							<p>Which You Have Never Seen Before!!</p>
...
he concept of music in Africa, especially in sub-Saharan Africa bears a difference from other regions and cultures. The roles of music and dance are tightly woven together in sub-Saharan Africa, and music intersects with every aspect of life, expresses life through the medium of sound. By helping mark the important moments in life, music helps to underscore the divine and eternal value of human life.</p>
			...
			<div class="col-md-3 bottom-four">
				<div class="bottom-text">
					<h3>FOLK MUSIC</h3>
					<p>folk music has been defined in several ways: as music transmitted orally, or as music with unknown composers. It has been contrasted with commercial and classical styles. One meaning often given is that of old songs with no known composers; another is music that has been transmitted and evolved by a process of oral transmission or performed by custom over a long period of time.</p>
				</div>
			</div>
...
<div class="full">
	<div class="container">
		<div class="col-md-4 full-grid">
			...
			<p>Donec nulla justo, pharetra nulla, lacinia pulvinar nunc rutrum nisi vel nib  impedit quo minus id quod maxime placeat facere
			possimus, omnis voluptas assumenda est, omnis dolor repellendus. </p>
			<a class="hvr-bounce-to-bottom read-more" href="album.php">MORE</a>
		</div>
		<div class="col-md-4 full-grid">
			<div class="full-text">
				<div class="full-left">
